      ...
      <div className="container px-4 lg:mx-auto lg:flex lg:flex-row-reverse lg:items-center mx-auto">
        ...
        <div className="lg:w-7/12 text-center lg:text-left">
          ...
          <p dangerouslySetInnerHTML={{ __html: headlineData.subHeadline }} />
            ...
            <a href="/resume.pdf" className="btn btn-icon btn-primary mt-8" target="_blank" aria-label="Download resume">Download resume <TfiNewWindow /></a>
            <a href="#testimonials" className="btn btn-primary-outline mt-8 ml-4" onClick={(e) => handleScroll(e, '#testimonials')} aria-label="See clients feedback">See clients feedback</a>
        </div>
